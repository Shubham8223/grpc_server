...
type UserServiceClient interface {
	...
	// Client Streaming
	CreateUsers(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[User, UsersResponse], error)
	// BiDi Streaming
...
func (c *userServiceClient) CreateUsers(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[User, UsersResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &UserService_ServiceDesc.Streams[1], UserService_CreateUsers_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[User, UsersResponse]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type UserService_CreateUsersClient = grpc.ClientStreamingClient[User, UsersResponse]
...
type UserServiceServer interface {
	...
	// Client Streaming
	CreateUsers(grpc.ClientStreamingServer[User, UsersResponse]) error
	// BiDi Streaming
...
func (UnimplementedUserServiceServer) CreateUsers(grpc.ClientStreamingServer[User, UsersResponse]) error {
...
func _UserService_CreateUsers_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(UserServiceServer).CreateUsers(&grpc.GenericServerStream[User, UsersResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type UserService_CreateUsersServer = grpc.ClientStreamingServer[User, UsersResponse]
